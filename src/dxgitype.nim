...
import winim/lean, dxgicommon, dxgiformat
type
  DXGI_MODE_ROTATION* = enum
    DXGI_MODE_ROTATION_UNSPECIFIED = 0x0, DXGI_MODE_ROTATION_IDENTITY = 0x1,
    DXGI_MODE_ROTATION_ROTATE90 = 0x2, DXGI_MODE_ROTATION_ROTATE180 = 0x3,
    DXGI_MODE_ROTATION_ROTATE270 = 0x4
  DXGI_MODE_SCANLINE_ORDER* = enum
  ...
  DXGI_MODE_SCALING* = enum
    DXGI_MODE_SCALING_UNSPECIFIED = 0x0, DXGI_MODE_SCALING_CENTERED = 0x1,
...
type
  ...
  DXGI_GAMMA_CONTROL_CAPABILITIES* {.bycopy.} = object
