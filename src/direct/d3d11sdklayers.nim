import winim/lean
import dxgi,d3d11
const IID_ID3D11Debug* = IID(Data1:0x79cf2233'i32, Data2:0x7536, Data3:0x4948, Data4:[0x9d'u8, 0x36, 0x1e, 0x46, 0x92, 0xdc, 0x57, 0x60])
const IID_ID3D11SwitchToRef* = IID(Data1:0x1ef337e3'i32, Data2:0x58e7, Data3:0x4f83, Data4:[0xa6'u8, 0x92, 0xdb, 0x22, 0x1f, 0x5e, 0xd4, 0x7e])
const IID_ID3D11InfoQueue* = IID(Data1:0x6543dbb6'i32, Data2:0x1b48, Data3:0x42f5, Data4:[0xab'u8, 0x82, 0xe9, 0x7e, 0xc7, 0x43, 0x26, 0xf6])
...
type
  D3D11_MESSAGE_CATEGORY* = enum
    ...
    D3D11_MESSAGE_CATEGORY_INITIALIZATION = 2, D3D11_MESSAGE_CATEGORY_CLEANUP = 3,
    ...
    D3D11_MESSAGE_CATEGORY_EXECUTION = 9, D3D11_MESSAGE_CATEGORY_SHADER = 10
  ...
  D3D11_MESSAGE_ID* = enum
    ...
    D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_OUTOFMEMORY = 171, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_INVALIDSHADERBYTECODE = 172, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_INVALIDSHADERTYPE = 173, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_INVALIDNUMENTRIES = 174, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_OUTPUTSTREAMSTRIDEUNUSED = 175,
    D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_UNEXPECTEDDECL = 176,
    D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_EXPECTEDDECL = 177, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_OUTPUTSLOT0EXPECTED = 178, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_INVALIDOUTPUTSLOT = 179, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_ONLYONEELEMENTPERSLOT = 180, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_INVALIDCOMPONENTCOUNT = 181, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_INVALIDSTARTCOMPONENTANDCOMPONENTCOUNT = 182, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_INVALIDGAPDEFINITION = 183,
    D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_REPEATEDOUTPUT = 184, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_INVALIDOUTPUTSTREAMSTRIDE = 185, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_MISSINGSEMANTIC = 186,
    D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_MASKMISMATCH = 187, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_CANTHAVEONLYGAPS = 188,
    D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_DECLTOOCOMPLEX = 189, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_MISSINGOUTPUTSIGNATURE = 190,
    ...
    D3D11_MESSAGE_ID_CREATEDEPTHSTENCILSTATE_INVALIDDEPTHFUNC = 201, D3D11_MESSAGE_ID_CREATEDEPTHSTENCILSTATE_INVALIDFRONTFACESTENCILFAILOP = 202, D3D11_MESSAGE_ID_CREATEDEPTHSTENCILSTATE_INVALIDFRONTFACESTENCILZFAILOP = 203, D3D11_MESSAGE_ID_CREATEDEPTHSTENCILSTATE_INVALIDFRONTFACESTENCILPASSOP = 204,
    D3D11_MESSAGE_ID_CREATEDEPTHSTENCILSTATE_INVALIDFRONTFACESTENCILFUNC = 205, D3D11_MESSAGE_ID_CREATEDEPTHSTENCILSTATE_INVALIDBACKFACESTENCILFAILOP = 206, D3D11_MESSAGE_ID_CREATEDEPTHSTENCILSTATE_INVALIDBACKFACESTENCILZFAILOP = 207, D3D11_MESSAGE_ID_CREATEDEPTHSTENCILSTATE_INVALIDBACKFACESTENCILPASSOP = 208,
    ...
    D3D11_MESSAGE_ID_DEVICE_RESOLVESUBRESOURCE_DESTINATION_INVALID = 290, D3D11_MESSAGE_ID_DEVICE_RESOLVESUBRESOURCE_DESTINATION_SUBRESOURCE_INVALID = 291,
    D3D11_MESSAGE_ID_DEVICE_RESOLVESUBRESOURCE_SOURCE_INVALID = 292, D3D11_MESSAGE_ID_DEVICE_RESOLVESUBRESOURCE_SOURCE_SUBRESOURCE_INVALID = 293,
    ...
    D3D11_MESSAGE_ID_REF_OUT_OF_MEMORY = 333, D3D11_MESSAGE_ID_REF_INFO = 334,
    ...
    D3D11_MESSAGE_ID_DEVICE_DRAW_SO_STRIDE_LARGER_THAN_BUFFER = 375, D3D11_MESSAGE_ID_DEVICE_DRAW_OM_RENDER_TARGET_DOES_NOT_SUPPORT_BLENDING = 376, D3D11_MESSAGE_ID_DEVICE_DRAW_OM_DUAL_SOURCE_BLENDING_CAN_ONLY_HAVE_RENDER_TARGET_0 = 377,
    ...
    D3D11_MESSAGE_ID_CREATEINPUTLAYOUT_TRAILING_DIGIT_IN_SEMANTIC = 385, D3D11_MESSAGE_ID_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_TRAILING_DIGIT_IN_SEMANTIC = 386,
    ...
    D3D11_MESSAGE_ID_CREATECOUNTER_OUTOFRANGE_COUNTER = 396, D3D11_MESSAGE_ID_CREATECOUNTER_SIMULTANEOUS_ACTIVE_COUNTERS_EXHAUSTED = 397,
    ...
    D3D11_MESSAGE_ID_DEVICE_DRAW_RESOURCE_FORMAT_GATHER_UNSUPPORTED = 416, D3D11_MESSAGE_ID_DEVICE_DRAW_INVALID_USE_OF_CENTER_MULTISAMPLE_PATTERN = 417,
    ...
    D3D11_MESSAGE_ID_LIVE_OBJECT_SUMMARY = 422, D3D11_MESSAGE_ID_LIVE_BUFFER = 423,
    D3D11_MESSAGE_ID_LIVE_TEXTURE1D = 424, D3D11_MESSAGE_ID_LIVE_TEXTURE2D = 425,
    ...
    D3D11_MESSAGE_ID_LIVE_INPUTLAYOUT = 433, D3D11_MESSAGE_ID_LIVE_SAMPLER = 434,
    D3D11_MESSAGE_ID_LIVE_BLENDSTATE = 435,
    D3D11_MESSAGE_ID_LIVE_DEPTHSTENCILSTATE = 436,
    D3D11_MESSAGE_ID_LIVE_RASTERIZERSTATE = 437, D3D11_MESSAGE_ID_LIVE_QUERY = 438,
    D3D11_MESSAGE_ID_LIVE_PREDICATE = 439, D3D11_MESSAGE_ID_LIVE_COUNTER = 440,
    D3D11_MESSAGE_ID_LIVE_DEVICE = 441, D3D11_MESSAGE_ID_LIVE_SWAPCHAIN = 442,
    D3D11_MESSAGE_ID_D3D10_MESSAGES_END = 443,
    D3D11_MESSAGE_ID_D3D10L9_MESSAGES_START = 0x100000,
    D3D11_MESSAGE_ID_CREATEDEPTHSTENCILSTATE_STENCIL_NO_TWO_SIDED = 0x100001, D3D11_MESSAGE_ID_CREATERASTERIZERSTATE_DepthBiasClamp_NOT_SUPPORTED = 0x100002,
    ...
    D3D11_MESSAGE_ID_DEVICE_RSSETVIEWPORTS_TOO_MANY_VIEWPORTS = 0x100011, D3D11_MESSAGE_ID_DEVICE_IASETPRIMITIVETOPOLOGY_ADJACENCY_UNSUPPORTED = 0x100012,
    ...
    D3D11_MESSAGE_ID_CREATEBLENDSTATE_NO_ALPHA_TO_COVERAGE = 0x100018, D3D11_MESSAGE_ID_CREATERASTERIZERSTATE_DepthClipEnable_MUST_BE_TRUE = 0x100019, D3D11_MESSAGE_ID_DRAWINDEXED_STARTINDEXLOCATION_MUST_BE_POSITIVE = 0x10001a,
    D3D11_MESSAGE_ID_CREATESHADERRESOURCEVIEW_MUST_USE_LOWEST_LOD = 0x10001b, D3D11_MESSAGE_ID_CREATESAMPLERSTATE_MINLOD_MUST_NOT_BE_FRACTIONAL = 0x10001c,
    D3D11_MESSAGE_ID_CREATESAMPLERSTATE_MAXLOD_MUST_BE_FLT_MAX = 0x10001d, D3D11_MESSAGE_ID_CREATESHADERRESOURCEVIEW_FIRSTARRAYSLICE_MUST_BE_ZERO = 0x10001e, D3D11_MESSAGE_ID_CREATESHADERRESOURCEVIEW_CUBES_MUST_HAVE_6_SIDES = 0x10001f,
    ...
    D3D11_MESSAGE_ID_CREATERESOURCE_MSAA_PRECLUDES_SHADER_RESOURCE = 0x100022, D3D11_MESSAGE_ID_CREATERESOURCE_PRESENTATION_PRECLUDES_SHADER_RESOURCE = 0x100023,
    ...
    D3D11_MESSAGE_ID_CREATERESOURCE_NO_AUTOGEN_FOR_VOLUMES = 0x100028, D3D11_MESSAGE_ID_CREATERESOURCE_DXGI_FORMAT_R8G8B8A8_CANNOT_BE_SHARED = 0x100029,
    ...
    D3D11_MESSAGE_ID_SETBLENDSTATE_SAMPLE_MASK_CANNOT_BE_ZERO = 0x100035, D3D11_MESSAGE_ID_CREATERESOURCE_DIMENSION_EXCEEDS_FEATURE_LEVEL_DEFINITION = 0x100036, D3D11_MESSAGE_ID_CREATERESOURCE_ONLY_SINGLE_MIP_LEVEL_DEPTH_STENCIL_SUPPORTED = 0x100037,
    ...
    D3D11_MESSAGE_ID_DEVICE_DRAW_RASTERIZING_CONTROL_POINTS = 0x200043, D3D11_MESSAGE_ID_DEVICE_IASETPRIMITIVETOPOLOGY_TOPOLOGY_UNSUPPORTED = 0x200044,
    D3D11_MESSAGE_ID_DEVICE_DRAW_HS_DS_SIGNATURE_MISMATCH = 0x200045, D3D11_MESSAGE_ID_DEVICE_DRAW_HULL_SHADER_INPUT_TOPOLOGY_MISMATCH = 0x200046,
    ...
    D3D11_MESSAGE_ID_DEVICE_CREATESHADER_CLASSLINKAGE_FULL = 0x2000a0, D3D11_MESSAGE_ID_DEVICE_CHECKFEATURESUPPORT_UNRECOGNIZED_FEATURE = 0x2000a1, D3D11_MESSAGE_ID_DEVICE_CHECKFEATURESUPPORT_MISMATCHED_DATA_SIZE = 0x2000a2,
    ...
    D3D11_MESSAGE_ID_CHECKFEATURESUPPORT_FORMAT_DEPRECATED = 0x2000db, D3D11_MESSAGE_ID_DEVICE_UNORDEREDACCESSVIEW_RETURN_TYPE_MISMATCH = 0x2000dc,
    D3D11_MESSAGE_ID_DEVICE_UNORDEREDACCESSVIEW_NOT_SET = 0x2000dd, D3D11_MESSAGE_ID_DEVICE_DRAW_UNORDEREDACCESSVIEW_RENDERTARGETVIEW_OVERLAP = 0x2000de,
    ...
    D3D11_MESSAGE_ID_DEVICE_DISPATCH_THREADGROUPCOUNT_ZERO = 0x2000ef, D3D11_MESSAGE_ID_DEVICE_SHADERRESOURCEVIEW_STRUCTURE_STRIDE_MISMATCH = 0x2000f0,
    ...
    D3D11_MESSAGE_ID_ENQUEUESETEVENT_ACCESSDENIED_RETURN = 0x20010d, D3D11_MESSAGE_ID_DEVICE_OMSETRENDERTARGETSANDUNORDEREDACCESSVIEWS_NUMUAVS_INVALIDRANGE = 0x20010e,
    ...
    D3D11_MESSAGE_ID_CREATEDEVICECONTEXTSTATE_INVALIDFEATURELEVEL = 0x300017, D3D11_MESSAGE_ID_CREATEDEVICECONTEXTSTATE_FEATURELEVELS_NOT_SUPPORTED = 0x300018,
    ...
    D3D11_MESSAGE_ID_DECODEREXTENSION_INVALIDRESOURCE = 0x30003e, D3D11_MESSAGE_ID_CREATEVIDEOPROCESSORENUMERATOR_OUTOFMEMORY_RETURN = 0x30003f,
    D3D11_MESSAGE_ID_CREATEVIDEOPROCESSORENUMERATOR_NULLPARAM = 0x300040, D3D11_MESSAGE_ID_CREATEVIDEOPROCESSORENUMERATOR_INVALIDFRAMEFORMAT = 0x300041,
    D3D11_MESSAGE_ID_CREATEVIDEOPROCESSORENUMERATOR_INVALIDUSAGE = 0x300042, D3D11_MESSAGE_ID_CREATEVIDEOPROCESSORENUMERATOR_INVALIDINPUTFRAMERATE = 0x300043, D3D11_MESSAGE_ID_CREATEVIDEOPROCESSORENUMERATOR_INVALIDOUTPUTFRAMERATE = 0x300044, D3D11_MESSAGE_ID_CREATEVIDEOPROCESSORENUMERATOR_INVALIDWIDTHHEIGHT = 0x300045,
    ...
    D3D11_MESSAGE_ID_GETVIDEOPROCESSORRATECONVERSIONCAPS_NULLPARAM = 0x300049, D3D11_MESSAGE_ID_GETVIDEOPROCESSORRATECONVERSIONCAPS_INVALIDINDEX = 0x30004a,
    ...
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTTARGETRECT_NULLPARAM = 0x300051, D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTBACKGROUNDCOLOR_NULLPARAM = 0x300052, D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTBACKGROUNDCOLOR_INVALIDALPHA = 0x300053,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTCOLORSPACE_NULLPARAM = 0x300054,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTALPHAFILLMODE_NULLPARAM = 0x300055, D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTALPHAFILLMODE_UNSUPPORTED = 0x300056, D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTALPHAFILLMODE_INVALIDSTREAM = 0x300057, D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTALPHAFILLMODE_INVALIDFILLMODE = 0x300058,
    ...
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETOUTPUTTARGETRECT_NULLPARAM = 0x30005d, D3D11_MESSAGE_ID_VIDEOPROCESSORGETOUTPUTBACKGROUNDCOLOR_NULLPARAM = 0x30005e,
    ...
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETOUTPUTCONSTRICTION_NULLPARAM = 0x300061, D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTCONSTRICTION_UNSUPPORTED = 0x300062, D3D11_MESSAGE_ID_VIDEOPROCESSORSETOUTPUTCONSTRICTION_INVALIDSIZE = 0x300063,
    ...
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMFRAMEFORMAT_NULLPARAM = 0x300066, D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMFRAMEFORMAT_INVALIDFORMAT = 0x300067, D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMFRAMEFORMAT_INVALIDSTREAM = 0x300068,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMCOLORSPACE_NULLPARAM = 0x300069, D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMCOLORSPACE_INVALIDSTREAM = 0x30006a,
    ...
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMOUTPUTRATE_INVALIDFLAG = 0x30006d, D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMOUTPUTRATE_INVALIDSTREAM = 0x30006e,
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMSOURCERECT_NULLPARAM = 0x30006f, D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMSOURCERECT_INVALIDSTREAM = 0x300070,
    ...
    D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMPALETTE_INVALIDALPHA = 0x30007b, D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMPIXELASPECTRATIO_NULLPARAM = 0x30007c, D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMPIXELASPECTRATIO_INVALIDSTREAM = 0x30007d, D3D11_MESSAGE_ID_VIDEOPROCESSORSETSTREAMPIXELASPECTRATIO_INVALIDRATIO = 0x30007e,
    ...
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMPALETTE_NULLPARAM = 0x300099, D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMPIXELASPECTRATIO_NULLPARAM = 0x30009a,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMLUMAKEY_NULLPARAM = 0x30009b,
    D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMSTEREOFORMAT_NULLPARAM = 0x30009c, D3D11_MESSAGE_ID_VIDEOPROCESSORGETSTREAMAUTOPROCESSINGMODE_NULLPARAM = 0x30009d,
    ...
    D3D11_MESSAGE_ID_VIDEOPROCESSORBLT_OUTPUTHAZARD = 0x3000b2, D3D11_MESSAGE_ID_CREATEVIDEODECODEROUTPUTVIEW_OUTOFMEMORY_RETURN = 0x3000b3,
    ...
    D3D11_MESSAGE_ID_CREATEVIDEODECODEROUTPUTVIEW_INVALIDDIMENSION = 0x3000bc, D3D11_MESSAGE_ID_CREATEVIDEOPROCESSORINPUTVIEW_OUTOFMEMORY_RETURN = 0x3000bd,
    ...
    D3D11_MESSAGE_ID_CREATEVIDEOPROCESSORINPUTVIEW_INVALIDDIMENSION = 0x3000c9, D3D11_MESSAGE_ID_CREATEVIDEOPROCESSOROUTPUTVIEW_OUTOFMEMORY_RETURN = 0x3000ca,
    ...
    D3D11_MESSAGE_ID_CREATEVIDEOPROCESSOROUTPUTVIEW_UNSUPPORTEDMIP = 0x3000d0, D3D11_MESSAGE_ID_CREATEVIDEOPROCESSOROUTPUTVIEW_UNSUPPORTEDARRAY = 0x3000d1,
    D3D11_MESSAGE_ID_CREATEVIDEOPROCESSOROUTPUTVIEW_INVALIDARRAY = 0x3000d2, D3D11_MESSAGE_ID_CREATEVIDEOPROCESSOROUTPUTVIEW_INVALIDDIMENSION = 0x3000d3,
    D3D11_MESSAGE_ID_DEVICE_DRAW_INVALID_USE_OF_FORCED_SAMPLE_COUNT = 0x3000d4,
    D3D11_MESSAGE_ID_CREATEBLENDSTATE_INVALIDLOGICOPS = 0x3000d5, D3D11_MESSAGE_ID_CREATESHADERRESOURCEVIEW_INVALIDDARRAYWITHDECODER = 0x3000d6, D3D11_MESSAGE_ID_CREATEUNORDEREDACCESSVIEW_INVALIDDARRAYWITHDECODER = 0x3000d7, D3D11_MESSAGE_ID_CREATERENDERTARGETVIEW_INVALIDDARRAYWITHDECODER = 0x3000d8,
    ...
    D3D11_MESSAGE_ID_CREATEAUTHENTICATEDCHANNEL_OUTOFMEMORY_RETURN = 0x30010e, D3D11_MESSAGE_ID_GETAUTHENTICATEDCHANNELCERTIFICATESIZE_INVALIDCHANNEL = 0x30010f, D3D11_MESSAGE_ID_GETAUTHENTICATEDCHANNELCERTIFICATESIZE_NULLPARAM = 0x300110, D3D11_MESSAGE_ID_GETAUTHENTICATEDCHANNELCERTIFICATE_INVALIDCHANNEL = 0x300111,
    D3D11_MESSAGE_ID_GETAUTHENTICATEDCHANNELCERTIFICATE_NULLPARAM = 0x300112,
    D3D11_MESSAGE_ID_GETAUTHENTICATEDCHANNELCERTIFICATE_WRONGSIZE = 0x300113, D3D11_MESSAGE_ID_NEGOTIATEAUTHENTICATEDCHANNELKEYEXCHANGE_INVALIDCHANNEL = 0x300114, D3D11_MESSAGE_ID_NEGOTIATEAUTHENTICATEDCHANNELKEYEXCHANGE_NULLPARAM = 0x300115,
    ...
    D3D11_MESSAGE_ID_DEVICE_CREATEGEOMETRYSHADER_UAVSNOTSUPPORTED = 0x300148, D3D11_MESSAGE_ID_DEVICE_CREATEGEOMETRYSHADERWITHSTREAMOUTPUT_UAVSNOTSUPPORTED = 0x300149,
    D3D11_MESSAGE_ID_DEVICE_CREATEPIXELSHADER_UAVSNOTSUPPORTED = 0x30014a,
    D3D11_MESSAGE_ID_DEVICE_CREATECOMPUTESHADER_UAVSNOTSUPPORTED = 0x30014b, D3D11_MESSAGE_ID_DEVICE_OMSETRENDERTARGETSANDUNORDEREDACCESSVIEWS_INVALIDOFFSET = 0x30014c, D3D11_MESSAGE_ID_DEVICE_OMSETRENDERTARGETSANDUNORDEREDACCESSVIEWS_TOOMANYVIEWS = 0x30014d,
    ...
    D3D11_MESSAGE_ID_DEVICE_OPEN_SHARED_RESOURCE1_NOT_SUPPORTED = 0x300154, D3D11_MESSAGE_ID_DEVICE_OPEN_SHARED_RESOURCE_BY_NAME_NOT_SUPPORTED = 0x300155,
    ...
    D3D11_MESSAGE_ID_COPYSUBRESOURCEREGION_EMPTYSOURCEBOX = 0x30015e, D3D11_MESSAGE_ID_DEVICE_DRAW_OM_RENDER_TARGET_DOES_NOT_SUPPORT_LOGIC_OPS = 0x30015f,
    D3D11_MESSAGE_ID_DEVICE_DRAW_DEPTHSTENCILVIEW_NOT_SET = 0x300160,
    D3D11_MESSAGE_ID_DEVICE_DRAW_RENDERTARGETVIEW_NOT_SET = 0x300161, D3D11_MESSAGE_ID_DEVICE_DRAW_RENDERTARGETVIEW_NOT_SET_DUE_TO_FLIP_PRESENT = 0x300162, D3D11_MESSAGE_ID_DEVICE_UNORDEREDACCESSVIEW_NOT_SET_DUE_TO_FLIP_PRESENT = 0x300163,
    D3D11_MESSAGE_ID_D3D11_1_MESSAGES_END = 0x300164
  D3D11_RLDO_FLAGS* = enum
    D3D11_RLDO_SUMMARY = 1, D3D11_RLDO_DETAIL = 2
  ...
  D3D11_INFO_QUEUE_FILTER* {.bycopy.} = object
...
type
    ID3D11DebugVtbl* = object
        QueryInterface*: proc (This:ptr ID3D11Debug, riid:ptr IID, ppvObject:ptr pointer): HRESULT {.stdcall.}
        AddRef*: proc (This:ptr ID3D11Debug): ULONG {.stdcall.}
        Release*: proc (This:ptr ID3D11Debug): ULONG {.stdcall.}
        SetFeatureMask*: proc (This:ptr ID3D11Debug, Mask:UINT): HRESULT {.stdcall.}
        GetFeatureMask*: proc (This:ptr ID3D11Debug): UINT {.stdcall.}
        SetPresentPerRenderOpDelay*: proc (This:ptr ID3D11Debug, Milliseconds:UINT): HRESULT {.stdcall.}
        GetPresentPerRenderOpDelay*: proc (This:ptr ID3D11Debug): UINT {.stdcall.}
        SetSwapChain*: proc (This:ptr ID3D11Debug, pSwapChain:ptr IDXGISwapChain): HRESULT {.stdcall.}
        GetSwapChain*: proc (This:ptr ID3D11Debug, ppSwapChain:ptr ptr IDXGISwapChain): HRESULT {.stdcall.}
        ValidateContext*: proc (This:ptr ID3D11Debug, pContext:ptr ID3D11DeviceContext): HRESULT {.stdcall.}
        ReportLiveDeviceObjects*: proc (This:ptr ID3D11Debug, Flags:D3D11_RLDO_FLAGS): HRESULT {.stdcall.}
        ValidateContextForDispatch*: proc (This:ptr ID3D11Debug, pContext:ptr ID3D11DeviceContext): HRESULT {.stdcall.}
    ID3D11Debug* = object
        lpVtbl*: ptr ID3D11DebugVtbl
    ID3D11SwitchToRefVtbl* = object
        QueryInterface*: proc (This:ptr ID3D11SwitchToRef, riid:ptr IID, ppvObject:ptr pointer): HRESULT {.stdcall.}
        AddRef*: proc (This:ptr ID3D11SwitchToRef): ULONG {.stdcall.}
        Release*: proc (This:ptr ID3D11SwitchToRef): ULONG {.stdcall.}
        SetUseRef*: proc (This:ptr ID3D11SwitchToRef, useref1:BOOL): BOOL {.stdcall.}
        GetUseRef*: proc (This:ptr ID3D11SwitchToRef): BOOL {.stdcall.}
    ID3D11SwitchToRef* = object
        lpVtbl*: ptr ID3D11SwitchToRefVtbl
    ID3D11InfoQueueVtbl* = object
        QueryInterface*: proc (This:ptr ID3D11InfoQueue, riid:ptr IID, ppvObject:ptr pointer): HRESULT {.stdcall.}
        AddRef*: proc (This:ptr ID3D11InfoQueue): ULONG {.stdcall.}
        Release*: proc (This:ptr ID3D11InfoQueue): ULONG {.stdcall.}
        SetMessageCountLimit*: proc (This:ptr ID3D11InfoQueue, MessageCountLimit:UINT64): HRESULT {.stdcall.}
        ClearStoredMessages*: proc (This:ptr ID3D11InfoQueue) {.stdcall.}
        GetMessage*: proc (This:ptr ID3D11InfoQueue, MessageIndex:UINT64, pMessage:ptr D3D11_MESSAGE, pMessageByteLength:ptr SIZE_T): HRESULT {.stdcall.}
        GetNumMessagesAllowedByStorageFilter*: proc (This:ptr ID3D11InfoQueue): UINT64 {.stdcall.}
        GetNumMessagesDeniedByStorageFilter*: proc (This:ptr ID3D11InfoQueue): UINT64 {.stdcall.}
        GetNumStoredMessages*: proc (This:ptr ID3D11InfoQueue): UINT64 {.stdcall.}
        GetNumStoredMessagesAllowedByRetrievalFilter*: proc (This:ptr ID3D11InfoQueue): UINT64 {.stdcall.}
        GetNumMessagesDiscardedByMessageCountLimit*: proc (This:ptr ID3D11InfoQueue): UINT64 {.stdcall.}
        GetMessageCountLimit*: proc (This:ptr ID3D11InfoQueue): UINT64 {.stdcall.}
        AddStorageFilterEntries*: proc (This:ptr ID3D11InfoQueue, pFilter:ptr D3D11_INFO_QUEUE_FILTER): HRESULT {.stdcall.}
        GetStorageFilter*: proc (This:ptr ID3D11InfoQueue, pFilter:ptr D3D11_INFO_QUEUE_FILTER, pFilterByteLength:ptr SIZE_T): HRESULT {.stdcall.}
        ClearStorageFilter*: proc (This:ptr ID3D11InfoQueue) {.stdcall.}
        PushEmptyStorageFilter*: proc (This:ptr ID3D11InfoQueue): HRESULT {.stdcall.}
        PushCopyOfStorageFilter*: proc (This:ptr ID3D11InfoQueue): HRESULT {.stdcall.}
        PushStorageFilter*: proc (This:ptr ID3D11InfoQueue, pFilter:ptr D3D11_INFO_QUEUE_FILTER): HRESULT {.stdcall.}
        PopStorageFilter*: proc (This:ptr ID3D11InfoQueue) {.stdcall.}
        GetStorageFilterStackSize*: proc (This:ptr ID3D11InfoQueue): UINT {.stdcall.}
        AddRetrievalFilterEntries*: proc (This:ptr ID3D11InfoQueue, pFilter:ptr D3D11_INFO_QUEUE_FILTER): HRESULT {.stdcall.}
        GetRetrievalFilter*: proc (This:ptr ID3D11InfoQueue, pFilter:ptr D3D11_INFO_QUEUE_FILTER, pFilterByteLength:ptr SIZE_T): HRESULT {.stdcall.}
        ClearRetrievalFilter*: proc (This:ptr ID3D11InfoQueue) {.stdcall.}
        PushEmptyRetrievalFilter*: proc (This:ptr ID3D11InfoQueue): HRESULT {.stdcall.}
        PushCopyOfRetrievalFilter*: proc (This:ptr ID3D11InfoQueue): HRESULT {.stdcall.}
        PushRetrievalFilter*: proc (This:ptr ID3D11InfoQueue, pFilter:ptr D3D11_INFO_QUEUE_FILTER): HRESULT {.stdcall.}
        PopRetrievalFilter*: proc (This:ptr ID3D11InfoQueue) {.stdcall.}
        GetRetrievalFilterStackSize*: proc (This:ptr ID3D11InfoQueue): UINT {.stdcall.}
        AddMessage*: proc (This:ptr ID3D11InfoQueue, Category:D3D11_MESSAGE_CATEGORY, Severity:D3D11_MESSAGE_SEVERITY, ID:D3D11_MESSAGE_ID, pDescription:LPCSTR): HRESULT {.stdcall.}
        AddApplicationMessage*: proc (This:ptr ID3D11InfoQueue, Severity:D3D11_MESSAGE_SEVERITY, pDescription:LPCSTR): HRESULT {.stdcall.}
        SetBreakOnCategory*: proc (This:ptr ID3D11InfoQueue, Category:D3D11_MESSAGE_CATEGORY, bEnable:BOOL): HRESULT {.stdcall.}
        SetBreakOnSeverity*: proc (This:ptr ID3D11InfoQueue, Severity:D3D11_MESSAGE_SEVERITY, bEnable:BOOL): HRESULT {.stdcall.}
        SetBreakOnID*: proc (This:ptr ID3D11InfoQueue, ID:D3D11_MESSAGE_ID, bEnable:BOOL): HRESULT {.stdcall.}
        GetBreakOnCategory*: proc (This:ptr ID3D11InfoQueue, Category:D3D11_MESSAGE_CATEGORY): BOOL {.stdcall.}
        GetBreakOnSeverity*: proc (This:ptr ID3D11InfoQueue, Severity:D3D11_MESSAGE_SEVERITY): BOOL {.stdcall.}
        GetBreakOnID*: proc (This:ptr ID3D11InfoQueue, ID:D3D11_MESSAGE_ID): BOOL {.stdcall.}
        SetMuteDebugOutput*: proc (This:ptr ID3D11InfoQueue, bMute:BOOL) {.stdcall.}
        GetMuteDebugOutput*: proc (This:ptr ID3D11InfoQueue): BOOL {.stdcall.}
    ID3D11InfoQueue* = object
        lpVtbl*: ptr ID3D11InfoQueueVtbl
